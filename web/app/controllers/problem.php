...
<div class="row d-flex justify-content-center">
	<span class="badge badge-secondary mr-1">时间限制:<?=$time_limit!=null?"$time_limit ms":"N/A"?></span>
...
<div class="btn-group float-right" role="group" aria-label="...">
	<a role="button" class="btn btn-info" href="/download.php?type=data&id=<?= $problem['id'] ?>"><span class="glyphicon glyphicon-download"></span>下载测试数据</a>
