...
<!--
			...
			<li class="nav-item"><a class="nav-link" href="<?= HTML::url('/hacks') ?>"><span class="glyphicon glyphicon-cutlery"></span> <?= UOJLocale::get('hacks') ?></a></li>
...
-->			<li class="nav-item"><a class="nav-link" href="<?= HTML::url('/contests') ?>"><span class="glyphicon glyphicon-hand-down"></span> <?= UOJLocale::get('contests') ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="<?= HTML::url('/problems') ?>"><span class="glyphicon glyphicon-hand-right"></span> <?= UOJLocale::get('problems') ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="<?= HTML::url('/submissions') ?>"><span class="glyphicon glyphicon-hand-up"></span> <?= UOJLocale::get('submissions') ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="<?= HTML::url('/hacks') ?>"><span class="glyphicon glyphicon-hand-down"></span> <?= UOJLocale::get('hacks') ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="<?= HTML::blog_list_url() ?>"><span class="glyphicon glyphicon-hand-left"></span> <?= UOJLocale::get('blogs') ?></a></li>
                        <li class="nav-item"><a class="nav-link" href="<?= HTML::url('/faq') ?>"><span class="glyphicon glyphicon-hand-right"></span> <?= UOJLocale::get('help') ?></a></li>
